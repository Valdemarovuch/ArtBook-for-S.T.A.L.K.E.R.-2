                  ...
                  <div className="space-y-6 text-sm text-white/70">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p>Натисніть кнопку "Поділитися" в КПК, щоб згенерувати унікальне посилання. Відправте його друзям — вони побачать, яких карток вам не вистачає і які ви віддаєте.</p>
                      </div>
                    </div>
